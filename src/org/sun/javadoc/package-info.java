...
The invocation is defined by the abstract {@link org.sun.javadoc.Doclet} class
-- the entry point is the {@link org.sun.javadoc.Doclet#start(RootDoc) start} method:
<pre>
    public static boolean <b>start</b>(RootDoc root)
</pre>
The {@link org.sun.javadoc.RootDoc} instance holds the root of the program structure
...
{@link org.sun.javadoc.PackageDoc#allClasses(boolean) allClasses(false)}.)
<p>

<a name="class"></a>
Throughout this API, the term <em>class</em> is normally a
shorthand for "class or interface", as in: {@link org.sun.javadoc.ClassDoc},
{@link org.sun.javadoc.PackageDoc#allClasses() allClasses()}, and
{@link org.sun.javadoc.PackageDoc#findClass(String) findClass(String)}.
In only a couple of other places, it means "class, as opposed to interface",
as in:  {@link org.sun.javadoc.Doc#isClass()}.
In the second sense, this API calls out four kinds of classes:
{@linkplain org.sun.javadoc.Doc#isOrdinaryClass() ordinary classes},
{@linkplain org.sun.javadoc.Doc#isEnum() enums},
{@linkplain org.sun.javadoc.Doc#isError() errors} and
{@linkplain org.sun.javadoc.Doc#isException() exceptions}.
...
{@link org.sun.javadoc.Doclet Doclet} is an abstract class that specifies
the invocation interface for doclets,
{@link org.sun.javadoc.Doclet Doclet} holds class or interface information,
{@link org.sun.javadoc.ExecutableMemberDoc} is a
superinterface of {@link org.sun.javadoc.MethodDoc} and
{@link org.sun.javadoc.ConstructorDoc},
and {@link org.sun.javadoc.ParamTag} holds information
...
@see org.sun.javadoc.Doclet
@see org.sun.javadoc.RootDoc
*/
@jdk.Exported
package org.sun.javadoc;
