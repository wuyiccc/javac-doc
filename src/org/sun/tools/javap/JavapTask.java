...
import org.sun.tools.classfile.*;
...
public class JavapTask implements DisassemblerTool.DisassemblerTask, Messages {
    ...
    private static final String versionRBName = "org.sun.tools.javap.resources.version";
    ...
    public String getMessage(Locale locale, String key, Object... args) {
        ...
        if (b == null) {
            try {
                b = ResourceBundle.getBundle("org.sun.tools.javap.resources.javap", locale);
