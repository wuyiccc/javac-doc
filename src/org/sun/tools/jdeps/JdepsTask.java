...
import org.sun.tools.classfile.Dependencies;
import org.sun.tools.classfile.Dependencies.ClassFileError;
import org.sun.tools.classfile.Dependency;
import org.sun.tools.classfile.Dependency.Location;
import org.sun.tools.jdeps.PlatformClassPath.JDKArchive;
import static org.sun.tools.jdeps.Analyzer.Type.*;
import java.io.*;
...
class JdepsTask {
    ...
    private static class ResourceBundleHelper {
        ...
        static {
            ...
            try {
                bundle = ResourceBundle.getBundle("org.sun.tools.jdeps.resources.jdeps", locale);
            } catch (MissingResourceException e) {
                throw new InternalError("Cannot find jdeps resource bundle for locale " + locale);
            }
            try {
                versionRB = ResourceBundle.getBundle("org.sun.tools.jdeps.resources.version");
            } catch (MissingResourceException e) {
                throw new InternalError("version.resource.missing");
            }
            try {
                jdkinternals = ResourceBundle.getBundle("org.sun.tools.jdeps.resources.jdkinternals");
            } catch (MissingResourceException e) {
