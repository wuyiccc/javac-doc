...
import org.sun.tools.javac.code.TypeTag;
import org.sun.tools.javac.comp.AttrContext;
import org.sun.tools.javac.comp.Env;
import org.sun.tools.javac.tree.JCTree;
import org.sun.tools.javac.tree.JCTree.JCFieldAccess;
import org.sun.tools.javac.tree.JCTree.JCImport;
...
import static org.sun.tools.javac.code.TypeTag.CLASS;
...
public class ClassDocImpl extends ProgramElementDocImpl implements ClassDoc {
    ...
    public org.sun.javadoc.Type getElementType() {
        return null;
    }
     ...
     */
    public org.sun.javadoc.Type superclassType() {
     ...
     * Return an empty array if there are no interfaces.
     */
    public org.sun.javadoc.Type[] interfaceTypes() {
        //### Cache result here?
