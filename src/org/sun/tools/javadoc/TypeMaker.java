...
import org.sun.tools.javac.code.Symbol.CompletionFailure;
...
import static org.sun.tools.javac.code.TypeTag.ARRAY;
...
public class TypeMaker {
    ...
    public static org.sun.javadoc.Type getType(DocEnv env, Type t) {
    ...
    private static org.sun.javadoc.Type getTypeImpl(DocEnv env, Type t,
            boolean errToClassDoc, boolean considerAnnotations) {
        if (env.legacyDoclet) {
     ...
     */
    public static org.sun.javadoc.Type[] getTypes(DocEnv env, List<Type> ts) {
        return getTypes(env, ts, new org.sun.javadoc.Type[ts.length()]);
    }
    ...
    private static class ArrayTypeImpl implements org.sun.javadoc.Type {
