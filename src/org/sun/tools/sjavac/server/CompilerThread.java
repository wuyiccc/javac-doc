...
package org.sun.tools.sjavac.server;
...
import org.sun.tools.javac.util.BaseFileManager;
import org.sun.tools.javac.util.StringUtils;
import org.sun.tools.sjavac.comp.Dependencies;
import org.sun.tools.sjavac.comp.JavaCompilerWithDeps;
import org.sun.tools.sjavac.comp.SmartFileManager;
import org.sun.tools.sjavac.comp.ResolveWithDeps;
...
public class CompilerThread implements Runnable {
    ...
    private org.sun.tools.javac.api.JavacTool compiler;
    ...
    public synchronized void use() {
        assert(!inUse);
        inUse = true;
        compiler = org.sun.tools.javac.api.JavacTool.create();
    ...
    public void run() {
        ...
        try {
            ...
            org.sun.tools.javac.util.ListBuffer<JavaFileObject> compilationUnits =
                new org.sun.tools.javac.util.ListBuffer<JavaFileObject>();
            for (JavaFileObject i : fileManager.getJavaFileObjectsFromFiles(the_classes)) {
                compilationUnits.append(i);
            }
            // Now deal with sources supplied as source_to_compile.
            org.sun.tools.javac.util.ListBuffer<File> sourcesToCompileFiles =
                new org.sun.tools.javac.util.ListBuffer<File>();
            ...
            org.sun.tools.javac.main.Main.Result rc = org.sun.tools.javac.main.Main.Result.OK;
            try {
                if (compilationUnits.size() > 0) {
                    ...
                    // Process the options.
                    org.sun.tools.javac.api.JavacTool.processOptions(context, smartFileManager, the_options);
                    ...
                    org.sun.tools.javac.main.Main ccompiler = new org.sun.tools.javac.main.Main("javacTask", stderr);
