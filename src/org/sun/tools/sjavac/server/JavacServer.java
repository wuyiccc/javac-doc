...
import org.sun.tools.sjavac.Util;
import org.sun.tools.sjavac.ProblemException;
import java.io.*;
import java.util.*;
...
public class JavacServer {
    ...
    public static int useServer(String settings, String[] args,
        ...
        try {
            ...
            // to point to a org.sun.tools.sjavac.Main that supports --startserver
            // for example by setting: sjavac=java%20-jar%20...javac.jar%org.sun.tools.sjavac.Main
