...
import org.sun.source.util.Plugin;
import org.sun.tools.doclint.DocLint;
import org.sun.tools.javac.api.BasicJavacTask;
import org.sun.tools.javac.code.Source;
import org.sun.tools.javac.file.CacheFSInfo;
import org.sun.tools.javac.file.JavacFileManager;
import org.sun.tools.javac.jvm.Profile;
import org.sun.tools.javac.jvm.Target;
import org.sun.tools.javac.processing.AnnotationProcessingError;
import org.sun.tools.javac.processing.JavacProcessingEnvironment;
import org.sun.tools.javac.util.*;
import org.sun.tools.javac.util.Log.PrefixKind;
    ...
    public Collection<File> processArgs(String[] flags, String[] classNames) { // XXX sb protected
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "org.sun.tools.javac.Main";
            showClass(showClass);
        }
...
//    }
    ...
    public static final String javacBundleName =
        "org.sun.tools.javac.resources.javac";
//
