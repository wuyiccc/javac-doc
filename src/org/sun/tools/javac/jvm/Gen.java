...
package org.sun.tools.javac.jvm;

import java.util.*;

import org.sun.tools.javac.tree.TreeInfo.PosKind;
...
import static org.sun.tools.javac.jvm.ByteCodes.*;
import static org.sun.tools.javac.jvm.CRTFlags.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new org.sun.tools.javac.model.FilteredMemberList(clazz.members())) {
