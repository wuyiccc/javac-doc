 ...
 * questions.
 */
package org.sun.tools.javac.util;
...
import org.sun.tools.javac.code.Printer;
...
public class RichDiagnosticFormatter extends
    ...
    protected RichDiagnosticFormatter(Context context) {
        ...
        configuration = new RichConfigurationZ(Options.instance(context), formatter);
    ...
    public String format(JCDiagnostic diag, Locale l) {
        ...
        if (getConfiguration().isEnabled(RichConfigurationZ.RichFormatterFeature.WHERE_CLAUSES)) {
    ...
    protected class RichPrinter extends Printer {
        ...
        public String visitClassType(ClassType t, Locale locale) {
            if (t.isCompound() &&
                    getConfiguration().isEnabled(RichConfigurationZ.RichFormatterFeature.WHERE_CLAUSES)) {
                return localize(locale,
        ...
        protected String className(ClassType t, boolean longform, Locale locale) {
            ...
            if (sym.name.length() == 0 ||
                    !getConfiguration().isEnabled(RichConfigurationZ.RichFormatterFeature.SIMPLE_NAMES)) {
        ...
        public String visitTypeVar(TypeVar t, Locale locale) {
            if (unique(t) ||
                    !getConfiguration().isEnabled(RichConfigurationZ.RichFormatterFeature.UNIQUE_TYPEVAR_NAMES)) {
                return t.toString();
            }
            else {
                return localize(locale,
    ...
    @Override
    public RichConfigurationZ getConfiguration() {
        //the following cast is always safe - see init
        return (RichConfigurationZ)configuration;
    }

    /**
     * Configuration object provided by the rich formatter.
     */
    public static class RichConfigurationZ extends ForwardingConfigurationZ {

        /** set of enabled rich formatter's features */
        protected EnumSet<RichFormatterFeature> features;

        @SuppressWarnings("fallthrough")
        public RichConfigurationZ(Options options, AbstractDiagnosticFormatter formatter) {
