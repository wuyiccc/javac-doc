...
public class ForwardingDiagnosticFormatter<D extends Diagnostic<?>, F extends DiagnosticFormatter<D>>
     ...
     */
    protected ForwardingConfigurationZ configuration;

    public ForwardingDiagnosticFormatter(F formatter) {
        this.formatter = formatter;
        this.configuration = new ForwardingConfigurationZ(formatter.getConfiguration());
    }
     ...
     */
    public static class ForwardingConfigurationZ implements Configuration {

        /** The configurationr object to which the forwarding configuration delegates some settings */
        protected Configuration configuration;

        public ForwardingConfigurationZ(Configuration configuration) {
