...
*/
// Code duplicated in org.sun.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // In org.sun.tools.javac.jvm.Gen.genCatch we first set the type_index
    // to the catch type index - that value is only temporary.
    // Then in org.sun.tools.javac.jvm.Code.fillExceptionParameterPositions
