...
import org.sun.source.tree.IdentifierTree;
import org.sun.source.tree.MemberReferenceTree.ReferenceMode;
import org.sun.source.tree.MemberSelectTree;
import org.sun.source.tree.TreeVisitor;
import org.sun.source.util.SimpleTreeVisitor;
import org.sun.tools.javac.code.*;
import org.sun.tools.javac.code.Lint.LintCategory;
...
import static org.sun.tools.javac.code.Flags.ANNOTATION;
...
import static org.sun.tools.javac.code.TypeTag.WILDCARD;
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * org.sun.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
