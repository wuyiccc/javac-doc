...
package org.sun.tools.javac.api;
...
import org.sun.source.doctree.DocCommentTree;
import org.sun.source.doctree.DocTree;
import org.sun.source.tree.CatchTree;
import org.sun.source.tree.CompilationUnitTree;
import org.sun.source.tree.Scope;
import org.sun.source.tree.Tree;
import org.sun.source.util.DocSourcePositions;
import org.sun.source.util.DocTreePath;
import org.sun.source.util.DocTreeScanner;
import org.sun.source.util.DocTrees;
import org.sun.source.util.JavacTask;
import org.sun.source.util.TreePath;
import org.sun.tools.javac.code.Flags;
import org.sun.tools.javac.code.Kinds;
import org.sun.tools.javac.code.Symbol;
import org.sun.tools.javac.code.Symbol.ClassSymbol;
import org.sun.tools.javac.code.Symbol.MethodSymbol;
import org.sun.tools.javac.code.Symbol.PackageSymbol;
import org.sun.tools.javac.code.Symbol.TypeSymbol;
import org.sun.tools.javac.code.Symbol.VarSymbol;
import org.sun.tools.javac.code.Type;
import org.sun.tools.javac.code.Type.ArrayType;
import org.sun.tools.javac.code.Type.ClassType;
import org.sun.tools.javac.code.Type.ErrorType;
import org.sun.tools.javac.code.Type.UnionClassType;
import org.sun.tools.javac.code.Types;
import org.sun.tools.javac.code.Types.TypeRelation;
import org.sun.tools.javac.comp.Attr;
import org.sun.tools.javac.comp.AttrContext;
import org.sun.tools.javac.comp.Enter;
import org.sun.tools.javac.comp.Env;
import org.sun.tools.javac.comp.MemberEnter;
import org.sun.tools.javac.comp.Resolve;
import org.sun.tools.javac.model.JavacElements;
import org.sun.tools.javac.processing.JavacProcessingEnvironment;
import org.sun.tools.javac.tree.DCTree;
import org.sun.tools.javac.tree.DCTree.DCBlockTag;
import org.sun.tools.javac.tree.DCTree.DCDocComment;
import org.sun.tools.javac.tree.DCTree.DCEndPosTree;
import org.sun.tools.javac.tree.DCTree.DCErroneous;
import org.sun.tools.javac.tree.DCTree.DCIdentifier;
import org.sun.tools.javac.tree.DCTree.DCParam;
import org.sun.tools.javac.tree.DCTree.DCReference;
import org.sun.tools.javac.tree.DCTree.DCText;
import org.sun.tools.javac.tree.EndPosTable;
import org.sun.tools.javac.tree.JCTree;
import org.sun.tools.javac.tree.JCTree.*;
import org.sun.tools.javac.tree.TreeCopier;
import org.sun.tools.javac.tree.TreeInfo;
import org.sun.tools.javac.tree.TreeMaker;
import org.sun.tools.javac.util.Abort;
import org.sun.tools.javac.util.Assert;
import org.sun.tools.javac.util.Context;
import org.sun.tools.javac.util.JCDiagnostic;
import org.sun.tools.javac.util.List;
import org.sun.tools.javac.util.ListBuffer;
import org.sun.tools.javac.util.Log;
import org.sun.tools.javac.util.Name;
import org.sun.tools.javac.util.Names;
import org.sun.tools.javac.util.Pair;
import org.sun.tools.javac.util.Position;
import static org.sun.tools.javac.code.TypeTag.*;
...
public class JavacTrees extends DocTrees {
    ...
    private VarSymbol searchField(ClassSymbol tsym, Name fieldName, Set<ClassSymbol> searched) {
        ...
        for (org.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(fieldName);
    ...
    /** @see org.sun.tools.javadoc.ClassDocImpl#findConstructor */
    MethodSymbol findConstructor(ClassSymbol tsym, List<Type> paramTypes) {
        for (org.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(names.init);
                e.scope != null; e = e.next()) {
    ...
    /** @see org.sun.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see org.sun.tools.javadoc.ClassDocImpl#searchMethod */
    private MethodSymbol searchMethod(ClassSymbol tsym, Name methodName,
        ...
        org.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(methodName);
    ...
    /** @see org.sun.tools.javadoc.ClassDocImpl */
