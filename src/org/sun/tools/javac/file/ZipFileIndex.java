...
package org.sun.tools.javac.file;
...
import org.sun.tools.javac.file.RelativePath.RelativeDirectory;
import org.sun.tools.javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
     ...
     */
    public synchronized org.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            org.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return org.sun.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            org.sun.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private org.sun.tools.javac.util.List<String> zipFileEntriesFiles = org.sun.tools.javac.util.List.<String>nil();
        private org.sun.tools.javac.util.List<String> zipFileEntriesDirectories = org.sun.tools.javac.util.List.<String>nil();
        private org.sun.tools.javac.util.List<Entry>  zipFileEntries = org.sun.tools.javac.util.List.<Entry>nil();
        ...
        private org.sun.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private org.sun.tools.javac.util.List<String> getDirectories() {
        ...
        private org.sun.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = org.sun.tools.javac.util.List.nil();
