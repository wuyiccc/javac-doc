...
package org.sun.tools.javac.sym;

import org.sun.tools.javac.api.JavacTaskImpl;
import org.sun.tools.javac.code.Kinds;
import org.sun.tools.javac.code.Scope;
import org.sun.tools.javac.code.Symbol.*;
import org.sun.tools.javac.code.Symbol;
import org.sun.tools.javac.code.Attribute;
import org.sun.tools.javac.code.Symtab;
import org.sun.tools.javac.code.Type;
import org.sun.tools.javac.code.Types;
import org.sun.tools.javac.jvm.ClassWriter;
import org.sun.tools.javac.jvm.Pool;
 ...
 *
 * <dl>
 * <dt>org.sun.tools.javac.sym.Jar</dt>
 * <dd>Specifies the location of rt.jar.</dd>
 * <dt>org.sun.tools.javac.sym.Dest</dt>
 ...
 */
@SupportedOptions({
    "org.sun.tools.javac.sym.Jar",
    "org.sun.tools.javac.sym.Dest",
    "org.sun.tools.javac.sym.Profiles"})
@SupportedAnnotationTypes("*")
public class CreateSymbols extends AbstractProcessor {

    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("org.sun.tools.javac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = pOptions.get("org.sun.tools.javac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Aorg.sun.tools.javac.sym.Jar=LOCATION_OF_JAR");
        String destName = pOptions.get("org.sun.tools.javac.sym.Dest");
        if (destName == null)
            throw new RuntimeException("Must use -Aorg.sun.tools.javac.sym.Dest=LOCATION_OF_JAR");
        String profileSpec=pOptions.get("org.sun.tools.javac.sym.Profiles");
        if (profileSpec == null)
            throw new RuntimeException("Must use -Aorg.sun.tools.javac.sym.Profiles=PROFILES_SPEC");
        ...
        org.sun.tools.javac.main.JavaCompiler compiler =
            org.sun.tools.javac.main.JavaCompiler.instance(task.getContext());
    ...
    public static void main(String... args) {
        ...
        args = new String[] {
            ...
            "-proc:only",
            "-processor",
            "org.sun.tools.javac.sym.CreateSymbols",
            "-Aorg.sun.tools.javac.sym.Jar=" + rt_jar,
            "-Aorg.sun.tools.javac.sym.Dest=" + dest,
            ...
            "org.w3c.dom.events",
            "org.w3c.dom.views",
            "org.sun.jndi.ldap.spi",
            "org.sun.management",
            "org.sun.security.auth",
            "org.sun.security.auth.callback",
            "org.sun.security.auth.login",
            "org.sun.security.auth.module",
            "org.sun.security.jgss",
            "org.sun.net.httpserver",
            "org.sun.net.httpserver.spi",
            "javax.smartcardio"
            // </editor-fold>
        };
        org.sun.tools.javac.Main.compile(args);
    }
