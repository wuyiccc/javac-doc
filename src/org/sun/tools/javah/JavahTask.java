...
//                throw new BadArgs("jni.no.stubs");
    ...
    private static final String versionRBName = "org.sun.tools.javah.resources.version";
    ...
    private String getMessage(Locale locale, String key, Object... args) {
        ...
        if (b == null) {
            try {
                b = ResourceBundle.getBundle("org.sun.tools.javah.resources.l10n", locale);
